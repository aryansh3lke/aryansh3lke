...
export const DATA = {
  ...
  summary:
    "After graduating from UC Davis with a Bachelor's degree in Computer Science, I felt lost and questioned whether I was genuinely passionate about this field or motivated by financial gain like many of my peers. In the past, my courses and projects were always about what someone else wanted me to do, not what I wanted. After a lot of introspection and learning, I discovered many things. I found that I enjoy the productivity, simplicity, and readability of high-level languages like Python and TypeScript much more than low-level ones like C/C++. I also realized I love picking up new frameworks and libraries to craft the perfect tech stack for my future apps. Starting out as a naïve front-end developer, I soon immersed myself in back-end development and DevOps so I could take my ideas all the way to production on my own.",
  skills: {
    Frontend: [
      "React",
      "Next.js",
