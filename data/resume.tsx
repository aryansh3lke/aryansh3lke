...
export const DATA = {
  ...
  description:
    "Full Stack Web Developer and Full Time Software Engineering Student @ SJSU. I enjoy creating helpful AI apps that are appealing to Internet normies.",
  summary:
    "After graduating from UC Davis with my Bachelor's degree in Computer Science, I was still lost wondering whether I was truly passionate about this field or in it for the money like many of my peers. In the past, all my courses and projects revolved around what someone else wanted me to do instead of something that incoporated my preferences. After lots of introspection and self-learning, I came to realize many things such as how I loved the productivity, simplicity, and readibility of high level languages like Python and Typescript far more than low level ones like C/C++, or how I enjoyed picking up new frameworks and libaries to craft the perfect tech stack for my next app. While I initially started out as just a naïve front-end developer, I quickly absorbed myself into the realms of backend development and devops to be able to take my ideas all the way to production all on my own.",
  skills: {
    Frontend: [
      "React",
      "Next.js",
    ...
    Backend: ["Flask", "FastAPI", "Python", "Postgres", "MongoDB"],
    DevOps: ["Docker", "Kubernetes", "AWS", "Vercel", "Railway"],
  },
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "Created an AI tool to periodically webscrape the top trends on X (Twitter) and generate summaries and sentiment scores to allow users to gain insight without having to waste time scrolling.",
      technologies: [
        "Next.js",
        "Typescript",
        "FastAPI",
    ...
    },
    {
      ...
      active: true,
      description:
        "Developed a SPA to allow students, researchers, and educators to save time watching long-form YouTube videos by receiving high quality summaries of the original video and comments and download videos at any available resolution.",
      technologies: [
        "React Router",
        "Typescript",
        "Flask",
    ...
    },
    {
      ...
      active: true,
      description:
        "Trained anime recommender systems using large Kaggle datasets and built a website to allow users to receive and save their recommendations to their watchlist.",
      technologies: [
        "Next.js",
        "Typescript",
        "Flask",
